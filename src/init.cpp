...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-finalizationdelay=<n>", strprintf(_("Set the minimum amount of time to wait between a block header reception and the block finalization. Unit is seconds (default: %d)", DEFAULT_MIN_FINALIZATION_DELAY), false, OptionsCategory::OPTIONS);
    ...
    strUsage += HelpMessageOpt("-maxreorgdepth=<n>", strprintf(_("Configure at what depth blocks are considered final (default: %d). Use -1 to disable.", DEFAULT_MAX_REORG_DEPTH), false, OptionsCategory::OPTIONS);
    if (showDebug) {
